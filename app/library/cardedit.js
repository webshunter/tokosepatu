...
export const ProdukCard = function ({ data }) {
    ...
    return (<>
        <div key={key} className="relative mb-[12px] flex-col flex border rounded border-inherit">
            <div className="flex text-[14px]">
                ...
                <div className="block lg:flex w-full">
                    ...
                    <div className="block md:flex w-full">
                        <div className="pl-[16px] pb-[16px] lg:pb-0 pr-[12px] flex min-h-[84px] w-full">
                        ...
                        <div className="pl-[16px] pr-[12px] flex flex-col min-h-[100px] w-full md:w-[111px] lg:w-[120px] border-t md:border-0 border-inherit">
                            <div className="pt-[12px] md:pt-0 lg:pt-[14px] pb-0 md:pb-[12px] pr-[16px] text-start lg:text-right">
                            {laku=="0"
                            ?
                                approval=="0"
                                ?
                            ...
                            <div className="flext self-end mt-[8px] md:mt-[12px] pb-4 md:pb-0">
                                <button onClick={() => {
                                    route.push('/post/update/' + uniqid)
                                }} className="p-2 md:p-2 z-10 shadow-md rounded-[8px] flex justify-start bg-white">
                                    <svg className="mt-[4px] mr-[4px]"
