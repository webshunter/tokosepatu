...
const ValidasiLogin = ( props ) => {
    ...
    if(session){
        ...
        return (<div className="block mt-10 text-center p-10 flex justify-center items-center">
            <div>
                <div style={{ display: hidden }} className="flex justify-center py-10">
                    <div role="status">
