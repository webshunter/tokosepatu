...
const ShareButton = ({ data }) => {
    ...
    return <>
        <div className='relative'>
            ...
            <div ref={ref} style={{ visibility: visible ? 'visible' : 'hidden' }} className="absolute top-[60px] right-[0] h-[100px] rounded text-gray-950 px-4 py-2 shadow-xl bg-white w-[320px]">
                <WhatsappShareButton
                    className='mx-[5px]'
                    url={'https://rumahjo.com/produk/'+properti.slug}
                    quote={properti.deskrisi}
                    hashtag="#muo"
                >
